...
inline void Bank::update_securities_prices()
{
...
inline void Bank::erase_obligation()
{
    srand (unsigned(time(NULL)));
...
inline void Bank::add_obligation()
{
    srand (unsigned(time(NULL)));
...
inline void Bank::buy_and_sell_securities()
{
    srand (unsigned(time(NULL)));
...
inline vector<struct bank_info> Bank::get_report_per_n_years(int n)
{
...
inline void get_delta(vector<struct bank_info> &a, int k, int m)   // get result of bank working from k to m year of its life
{
